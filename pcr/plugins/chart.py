...
# @on_command('chart',aliases=('制图'),only_to_me=False)
...
#     else:
#         if os.path.exists(res_path+'record/'+time+'.txt') :
#             record=open(res_path+'record/'+time+'.txt','r',encoding='utf-8')
